...
export const translations = {
  ...
  'packages.subtitle': {
    en: 'Single Session Tutoring • Book 1 session for targeted concepts or book up to 10 sessions with recurring options in all available dates. Change dates anytime in your Client Portal.',
    zh: '专属单课时辅导体系 • 可预约1次独立课时，或预约至多10次课时享受规律排课。学员中心支持随时自主改期。',
  },
  ...
  'packages.10pack.title': { en: 'Book up to 10 Recurring Sessions', zh: '预约至多 10 次规律课时' },
  'packages.10pack.subtitle': { en: 'Up to 10 lessons with recurring options in all available dates • Term foundation & sustained syllabus mastery', zh: '至多10节系统课时，支持在所有可用日期设置排课 • 学期基础夯实与大纲深度突破' },
  ...
  'admin.needsReviewTitle': { en: 'Pending Request (Needs Tutor Confirmation)', zh: '待确认申请 (需老师确认)' },
  ...
  'packages.book10Btn': { en: 'Book up to 10 Sessions', zh: '预约规律课时' },
  ...
  'portal.pendingReview': { en: 'Pending Request', zh: '审核中' },
