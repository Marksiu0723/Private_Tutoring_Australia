...
export const translations = {
  ...
  // Packages
  'packages.title': { en: 'Tutoring Packages', zh: '课时套餐方案' },
  'packages.subtitle': {
    en: 'Choose a single diagnostic lesson or establish a regular schedule with flexible multi-session plans.',
    zh: '可选择单次诊断课，或通过多课时套餐建立持续、规律的学习节奏。',
  },
  'packages.single.title': { en: 'Single Session', zh: '单次课时' },
  'packages.single.subtitle': { en: '1 individual lesson • Ideal for targeted exam review or topic deep dive', zh: '1节专属课时 • 适合考前突击答疑或单项难点攻克' },
  'packages.4pack.title': { en: '4-Session Plan', zh: '4次课时计划' },
  'packages.4pack.subtitle': { en: '4 lessons • Perfect for assessment preparation or module mastery', zh: '4节系统课时 • 适合阶段测验准备或单模块专项突破' },
  'packages.8pack.title': { en: '8-Session Plan', zh: '8次学期计划' },
  'packages.8pack.subtitle': { en: '8 lessons • Recommended for steady term-long foundation building', zh: '8节学期课时 • 推荐用于整个学期的稳步提分与基础夯实' },
  'packages.12pack.title': { en: '12-Session Plan', zh: '12次全面冲刺' },
  'packages.12pack.subtitle': { en: '12 lessons • Comprehensive syllabus coverage & sustained mentorship', zh: '12节全真辅导 • 适合完整覆盖整学期大纲或高三大考冲刺' },
  'packages.recommended': { en: 'Most Popular', zh: '最受家长欢迎' },
  'packages.select': { en: 'Select Package', zh: '选择此方案' },
  ...
  'how.step1.title': { en: '1. Select Service & Plan', zh: '1. 选择科目与课时套餐' },
  'how.step1.desc': { en: 'Choose Junior Science or HSC Chemistry/Biology, and pick single or multi-session packages.', zh: '根据年级挑选课程，并根据学习目标选择单次或课时包。' },
  'how.step2.title': { en: '2. Pick Your Schedule', zh: '2. 选择上课时间节奏' },
  'how.step2.desc': { en: 'Book one-time, weekly, fortnightly, or customize every individual lesson slot.', zh: '支持单次、每周固定、双周或完全由您自主自定义每一节课的时间。' },
  ...
  'how.step4.title': { en: '4. Manage in Client Portal', zh: '4. 学员中心自主管理' },
  'how.step4.desc': { en: 'Log in anytime to view your upcoming lessons, request rescheduling, or update notes.', zh: '随时登录学员中心查看所有待上课程，支持自主改期与管理。' },
